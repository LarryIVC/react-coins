...
const Details = () => {
  ...
  return (
    <>
      <h2 className='det-title'>Details <span>{coinData.name}</span></h2>
      <img className='icon' src={coinData.iconUrl} />
      <ul className='det-container'>
        ...
        <li className="listDetail">
          <span><strong>Descritpion: </strong>
          </span>
        ...
        <li className="listDetail">
          ...
          <span>{(coinData.price*1).toFixed(6).toLocaleString("en-US")}USD</span>
        </li>
        <li className="listDetail">
          <span>
            <strong>Rank: </strong>
